...
const ChromeUpdates = () => {
    return (
        <div className="max-w-6xl mx-auto text-center py-10 px-5 font-sans bg-white">
            ...
            <h1 className='text-5xl mb-10 font-bold mb-20 flex items-center justify-center'><span className="px-2 mr-2 inline-block mt-4 font-lg text-center text-blue-700 bg-[#E8F0FE] rounded-full inline-flex"><Image className="w-14 h-14" src="/updates.svg" alt='updates' height={20} width={20} />updates</span><span> from Chrome</span></h1>
            <div className="rounded-xl flex justify-center gap-6 max-w-7xl mx-auto">
                ...
                <h2 className="text-[#5f6368] text-medium font-bold text-left">LATEST </h2>
