...
const ChromeUpdates = () => {
    return (
        <div className="max-w-6xl mx-auto text-center py-10 px-5 font-sans bg-white">
            ...
            <h1 className='text-6xl mb-10 font-bold mb-20 flex items-center justify-center'><span className="px-2 mr-2 inline-block mt-4 font-medium text-center text-blue-700 bg-[#E8F0FE] rounded-full inline-flex"><Image className="w-20 h-20" src="/updates.svg" alt='updates' height={20} width={20} />updates</span> from Chrome</h1>
